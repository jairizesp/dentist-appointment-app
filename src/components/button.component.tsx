...
const Button = ({
  ...
  const variants = {
    primary:
      "bg-purple-800 text-purple-200 hover:bg-purple-200 hover:text-purple-800 active:scale-95 disabled:bg-purple-300 disabled:text-purple-200",
    secondary:
    ...
    >
      {isLoading ? (
        <div role="status">
          <svg
            aria-hidden="true"
            className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-purple-200"
            viewBox="0 0 100 101"
            fill="none"
